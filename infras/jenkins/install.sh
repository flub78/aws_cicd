...
# export JENKINS_URL=http://ratus.flub78.net:8080
...
java -jar jenkins-cli.jar -s http://ratus.flub78.net:8080/ -auth @jenkins_token install-plugin plot
java -jar jenkins-cli.jar -s http://ratus.flub78.net:8080/ -auth @jenkins_token install-plugin jdepend
java -jar jenkins-cli.jar -s http://ratus.flub78.net:8080/ -auth @jenkins_token install-plugin subversion
java -jar jenkins-cli.jar -s http://ratus.flub78.net:8080/ -auth @jenkins_token install-plugin violations
java -jar jenkins-cli.jar -s http://ratus.flub78.net:8080/ -auth @jenkins_token install-plugin warnings-ng
